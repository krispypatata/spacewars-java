...
public class Sprite {
	...
	//method to set the image to the image view node (flip image horizontally)
	public void renderFlipX(GraphicsContext gc){
		gc.drawImage(this.img, this.x+this.img.getWidth(), this.y, -this.img.getWidth(), this.img.getHeight());
    }
